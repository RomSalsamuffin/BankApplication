...
def filter_by_currency(
    list_of_transactions: list[dict], transaction_currency: str = "USD"
) -> Iterator[dict]:
    """
...
def card_number_generator(start: int, stop: int) -> Iterator[str]:
    ...
    if (
        start < min_card_number
        or start > max_card_number
        or stop < min_card_number
        or stop > max_card_number
        or start > stop
    ):
