...
def get_operation(json_path: str = None) -> list[dict]:
    ...
    if json_path:
        logger.info('Путь к json передан. Формирование полного абсолютного пути к json-файлу')
        ...
        logger.error('Путь к json-файлу в качестве аргумента не передан. Возврат пустого списка транзакций')
        return []
